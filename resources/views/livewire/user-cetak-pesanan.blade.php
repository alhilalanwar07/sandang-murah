        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-left">
                    ...
                    <span class="mt-0">Jl. Kancil, No.17 B, Kelurahan Andonohu, Kota
                        Kendari</span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <table class="table table-borderless">
                    <tbody align="left" style="line-height: 0.3; font-size: 12px" ;>
                        <td>
                            <tr>
                                <td>Kode Pesanan</td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-bordered border-dark" style="border: 1px solid black">
